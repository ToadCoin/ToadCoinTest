...
# Toadcoin
-----------
Copyright (c) 2011-2014 Toadcoin Developers
Copyright (c) 2011-2014 TOADoin Developers
=======
# Peershares
-----------
...
# What is Toadcoin?
--------------------
Toadcoin is an inexpensive and decentralized ledger to be used by 
...
Using Toadcoin, individuals, businesses, or organizations of any size could raise 
...
Toadcoin can be traded on any number of exchanges just as Peercoins can.

Each business using Toadcoin will have their own blockchain that is independent of all others. 
=======
# What is Peershares?
--------------------
...
<<<<<<< HEAD
 32/Toadcoin (GUI, 32-bit)
 32/Toadcoin-X.X.X-win-setup.exe (GUI installer, 32-bit)
 32/Toadcoind (command line, 32-bit)
 64/Toadcoin (GUI, 64-bit)
 64/Toadcoin-X.X.X-win-setup.exe (GUI installer, 64-bit)
 64/Toadcoind (command line, 64-bit)
=======
...
<<<<<<< HEAD
incoming connections.  Toadcoin works without incoming connections,
but allowing incoming connections helps the Toadcoin network.

# Resources
----------
Source Code: https://github.com/Toadcoin/Toadcoin
Wiki Page: https://github.com/Toadcoin/Toadcoin/wiki
Support Forum: http://www.peercointalk.org/index.php?board=61.0
Subreddit: http://www.reddit.com/toadcoin
=======
