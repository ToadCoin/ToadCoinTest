...
public:
    Distribution(CBitcoinAddress addrToadcoin, int64 nBalance, double dDividendAmount)
        : addrToadcoin(addrToadcoin), nBalance(nBalance), addrPeercoin(addrToadcoin), dDividendAmount(dDividendAmount)
    {
    }
