        ...
        CTxDB txdb("r");
        {
            ...
            loop
            {
                ...
                if (nChange > 0)
                {
                    ...
                    if (!GetBoolArg("-avatar", true)) // peercoin: not avatar mode; toadcoin: avatar mode enabled by default to avoid change being sent to hidden address
                    {
