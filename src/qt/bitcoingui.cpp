 ...
 * The Toadcoin Developers 2013-2014
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Toadcoin Portfolio"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/toadcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a Toadcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/toadcoin"), tr("&About %1").arg(qApp->applicationName()), this);
    aboutAction->setToolTip(tr("Show information about Toadcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Toadcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toadcoin"), tr("Show/Hide &Toadcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Toadcoin window"));
    ...
    exportPeercoinKeysAction->setToolTip(tr("Export the Peercoin keys associated with the Toadcoin addresses to Peercoin via RPC"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/toadcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/toadcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Toadcoin client"));
    ...
    notificator = new Notificator(tr("Toadcoin-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Toadcoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Toadcoin network", "", count));
}
