...
namespace Checkpoints
{
    ...
    // Toadcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // Toadcoin: get last synchronized checkpoint
    ...
    // Toadcoin: only descendant of current sync-checkpoint is allowed
    ...
    // Toadcoin: reset synchronized checkpoint to last hardened checkpoint
...
// Toadcoin: sync-checkpoint master key
...
// Toadcoin: verify signature of sync-checkpoint message
...
// Toadcoin: process synchronized checkpoint
