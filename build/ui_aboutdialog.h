...
public:
    ...
    QLabel *label_toadcoin_copyright;
    QLabel *label_2;
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_toadcoin_copyright = new QLabel(AboutDialog);
        label_toadcoin_copyright->setObjectName(QString::fromUtf8("label_toadcoin_copyright"));
        label_toadcoin_copyright->setWordWrap(true);
        label_toadcoin_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_toadcoin_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Toadcoin", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>Toadcoin</b> : version", 0, QApplication::UnicodeUTF8));
        label_toadcoin_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2013-2014 Toadcoin Developers", 0, QApplication::UnicodeUTF8));
